import 'package:bucket_list_with_firebase_flutter/auth_service.dart';
import 'package:bucket_list_with_firebase_flutter/bucket_service.dart';
          ...
          body: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Center(
                  child: Text(
                    user == null ? "로그인해 주세요 😃" : "${user?.email}님 안녕하세요 🖐️",
                    style: TextStyle(
                      fontSize: 24,
                    ),
                  ),
